...
class Formatters {
    ...
    /**
     * This method formats a date into a dd/mm/yyyy hh:mm date.
     *
    ...
    /**
     * This method formats a phone number into a xx.xx.xx.xx.xx format.
     *
    ...
    /**
     * This function strips the formatted phone number from '.' chars to allow it to be sent to the API.
     *
    ...
    /**
     * This method replaces a special char that can cause problems in requests bodies and parameters.
     *
